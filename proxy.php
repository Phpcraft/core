...
use Phpcraft\
{Account, ClientboundPacket, ClientConnection, Connection, Enum\Difficulty, Enum\Dimension, Enum\Gamemode, JoinGamePacket, KeepAliveRequestPacket, Phpcraft, Position, Server, ServerConnection, Versions};
