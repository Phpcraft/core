...
abstract class Packet
{
	private static function clientboundPackets()
	{
		return [
			...
			"clientbound_chat_message"      => [0x0E, 0x0F, 0x0F, 0x0F, 0x0F, 0x0F, 0x02],
			...
			"clientbound_plugin_message"    => [0x19, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3F],
			...
			"clientbound_player_abilities"  => [0x2E, 0x2C, 0x2B, 0x2B, 0x2B, 0x2B, 0x39],
			...
			"clientbound_held_item_change"  => [0x3D, 0x3A, 0x39, 0x37, 0x37, 0x37, 0x09],
	...
	private static function serverboundPackets()
	{
		return [
			...
			"serverbound_chat_message"      => [0x02, 0x02, 0x03, 0x02, 0x02, 0x02, 0x01],
			...
			"serverbound_plugin_message"    => [0x0A, 0x09, 0x0A, 0x09, 0x09, 0x09, 0x17],
			...
			"serverbound_player_abilities"  => [0x17, 0x13, 0x13, 0x12, 0x12, 0x12, 0x13],
			...
			"serverbound_held_item_changed" => [0x21, 0x1A, 0x1A, 0x17, 0x17, 0x17, 0x09],
