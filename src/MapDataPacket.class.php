...
class MapDataPacket extends Packet
{
	 ...
	 * @param array $rgb
	 * @param boolean $use_1_12_colors If true, 1.12+ colors are used. Otherwise, 1.8.1+ colors are used.
	 */
	static function getColorId($rgb, $use_1_12_colors = true)
	{
		$best_color = 0;
		$best_diff;
		foreach(($use_1_12_colors ? MapDataPacket::colors_1_12() : MapDataPacket::colors_1_8_1()) as $id => $rgb2)
		{
